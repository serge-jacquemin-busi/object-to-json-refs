...
describe('UseRealValueForParent', () => {
    [
        (() => {
            const parent = {};
            const parentNode = new object_node_1.NodeObject('', parent);
            const node = new object_node_1.NodeObject('', 55, parentNode, 'x');
            return {
                parent,
                node,
                expected: {
        ...
        (() => {
            const parent = {};
            const parentNode = new object_node_1.NodeObject('', parent);
            const node = new object_node_1.NodeObject('', { y: ['z'] }, parentNode, 'x');
            return {
                parent,
                node,
                expected: {
        ...
        it(`should set parent's property accordingly`, () => {
            // Arrange
            // Act
            index_1.UseRealValueForParent(node);
            // Assert
...
describe('MutateToRef', () => {
    [
        (() => {
            const parentNode = new object_node_1.NodeObject('', {});
            const node = new object_node_1.NodeObject('xyz', 55, parentNode, 'x');
            return {
                node,
                expected: {
                    $ref: 'xyz'
        ...
        (() => {
            const node = new object_node_1.NodeObject('abc', null);
            return {
                node,
                expected: {
                    $ref: 'abc'
...
describe('ConvertToNodeGraph', () => {
    it('should keep realValue on primitive', () => {
        // Arrange
        const realValue = {};
        const node = new object_node_1.NodeObject('', 55);
        const knownNodes = new WeakMap();
        const keptNodes = {};
        // Act
        const result = index_1.ConvertToNodeGraph(node, knownNodes, keptNodes);
        // Assert
    ...
    it('should keep realValue on leaf', () => {
        // Arrange
        const realValue = {};
        const node = new object_node_1.NodeObject('', realValue);
        const knownNodes = new WeakMap();
        const keptNodes = {};
        // Act
        const result = index_1.ConvertToNodeGraph(node, knownNodes, keptNodes);
